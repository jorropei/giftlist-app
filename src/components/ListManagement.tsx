...
import { Users, Plus, LogIn, Loader2, LogOut } from 'lucide-react';
        ...
        {!showCreateForm && !showJoinForm && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              ...
              className="glass-card p-6 sm:p-8 rounded-xl border border-gray-800 hover:border-indigo-500/30 transition-all flex flex-col items-center gap-4"
            >
              <Plus className="h-8 w-8 text-[#4F6BFF]" strokeWidth={1.5} />
              <span className="text-lg font-medium text-white">{t('createList')}</span>
            </button>
            <button
              onClick={() => setShowJoinForm(true)}
              className="glass-card p-6 sm:p-8 rounded-xl border border-gray-800 hover:border-indigo-500/30 transition-all flex flex-col items-center gap-4"
            >
              <LogIn className="h-8 w-8 text-[#4F6BFF]" strokeWidth={1.5} />
              <span className="text-lg font-medium text-white">{t('joinList')}</span>
            </button>
          </div>
        )}
